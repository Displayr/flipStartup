...
test_that("Displayr",{
    ...
    z = structure(list(value = c(3999, 7998, 3999, 7998), from = structure(c(1515070800, 
        ...
        TRUE, TRUE, TRUE), id = structure(c(1L, 2L, 6L, 13L), .Label = c("Avenue M Group", 
        "C+R Research", "EMBL Heidelberg", "GfK", "Illuminas", "KLA", 
        "Market Intelligence International", "Nielsen Sports", "Partners in Performance International Pty Ltd (company name: Partners in Performance)", 
        "Stellar Market Research Pty Limited", "StollzNow Research", 
        "Tapestry (company name: Tapestry Research)", "Toluna Hong Kong Ltd Singapore branch", 
        "Zillow Group"), class = "factor"), start = structure(c(1503532800, 
    ...
    z = structure(list(value = structure(c(NA, NA, NA, NA, NA, 3999, 
        ...
        FALSE, FALSE, FALSE, TRUE), id = structure(c(11L, 4L, 14L, 
        8L, 10L, 1L, 9L, 12L, 2L, 9L, 5L, 7L, 7L, 9L, 12L, 12L, 6L, 
        9L, 9L, 9L, 3L, 3L, 13L), .Label = c("Avenue M Group", "C+R Research", 
        "EMBL Heidelberg", "GfK", "Illuminas", "KLA", "Market Intelligence International", 
        "Nielsen Sports", "Partners in Performance International Pty Ltd (company name: Partners in Performance)", 
        "Stellar Market Research Pty Limited", "StollzNow Research", 
        "Tapestry (company name: Tapestry Research)", "Toluna Hong Kong Ltd Singapore branch", 
        "Zillow Group"), class = "factor"), start = structure(c(1503532800, 
    ...
    DisplayrTotalPaymentMonthlyRevenueData <- RevenueData(value = z$value, 
        from = z$from,
        to = z$end,
        subscription.length = "month",
        subset = z$subset, 
